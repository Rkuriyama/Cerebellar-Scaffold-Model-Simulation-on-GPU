...
void init_neurons_params( Neuron*, int*, std::string );
void init_connectivity_params( Connectivity*, Neuron*, int*, int*, std::string );


int LoadConnectivityFile(const std::string, unsigned int **,  unsigned int **, unsigned int **, CTYPE **, CTYPE, int , int );
