...
#define	granule_cell_num	(91380)
#define	glomerulus_num	(7194)
#define	purkinje_cell_num	(70)
#define	golgi_cell_num	(216)
#define	stellate_cell_num	(600)
#define	basket_cell_num	(596)
#define	dcn_cell_num	(14)
#define	dcn_interneuron_num	(14)
#define	io_cell_num	(10)
