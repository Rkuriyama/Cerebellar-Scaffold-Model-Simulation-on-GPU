...
#define	granule_cell_num	(275380)
#define	glomerulus_num	(21604)
#define	purkinje_cell_num	(216)
#define	golgi_cell_num	(648)
#define	stellate_cell_num	(1797)
#define	basket_cell_num	(1783)
#define	dcn_cell_num	(43)
#define	dcn_interneuron_num	(43)
#define	io_cell_num	(33)
