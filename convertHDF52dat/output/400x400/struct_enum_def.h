...
#define	granule_cell_num	(91473)
#define	glomerulus_num	(7193)
#define	purkinje_cell_num	(72)
#define	golgi_cell_num	(216)
#define	stellate_cell_num	(598)
#define	basket_cell_num	(592)
#define	dcn_cell_num	(14)
#define	dcn_interneuron_num	(14)
#define	io_cell_num	(11)
