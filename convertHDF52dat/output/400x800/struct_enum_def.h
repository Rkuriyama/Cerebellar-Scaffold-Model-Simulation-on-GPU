...
#define	granule_cell_num	(183291)
#define	glomerulus_num	(14399)
#define	purkinje_cell_num	(141)
#define	golgi_cell_num	(432)
#define	stellate_cell_num	(1199)
#define	basket_cell_num	(1195)
#define	dcn_cell_num	(28)
#define	dcn_interneuron_num	(28)
#define	io_cell_num	(23)
