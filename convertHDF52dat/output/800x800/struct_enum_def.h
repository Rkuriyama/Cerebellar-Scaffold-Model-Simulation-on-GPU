...
#define	granule_cell_num	(367626)
#define	glomerulus_num	(28798)
#define	purkinje_cell_num	(289)
#define	golgi_cell_num	(864)
#define	stellate_cell_num	(2396)
#define	basket_cell_num	(2376)
#define	dcn_cell_num	(57)
#define	dcn_interneuron_num	(57)
#define	io_cell_num	(47)
